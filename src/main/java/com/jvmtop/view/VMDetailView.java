      ...
      for (Long tid : cpuTimeMap.keySet())
      {
        ...
        if (info != null)
        {
          System.out.printf(
              ...
              tid, leftStr(info.getThreadName(), threadNameDisplayWidth_),
              info.getThreadState(),
              ...
              StackTraceElement[] stackTraceElements = vmInfo_.getThreadMXBean().getThreadInfo(tid, STACK_TRACE_ELEMENTS_SHOWN).getStackTrace();
